            ...
            <div class="card-content">
                <div class="row">
                    <div class="col s12" id="account">
                        <form id="form"  action="{{ route('employees.store') }}" class="form form-label-right" method="post"   enctype="multipart/form-data" >
                            @csrf
                            @method('post')
                            @if ($errors->any())
                                    ...
                                    <div class="col s12 input-field">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" class="form-control {{ inputError('name') }}" aria-describedby="basic-addon1" required>
                                    ...
                                    <div class="col s12 input-field">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" class="form-control {{ inputError('email') }}" aria-describedby="basic-addon1" required>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col s6 input-field">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="phone_number" class="form-control {{ inputError('phone_number') }}" aria-describedby="basic-addon1" required>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col s6 input-field">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="job_title" class="form-control {{ inputError('job_title') }}" aria-describedby="basic-addon1" required>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col s6 input-field">
                                        <div class="form-group validated">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="salary" class="form-control {{ inputError('salary') }}" aria-describedby="basic-addon1" >
                                                <div class="invalid-feedback">
