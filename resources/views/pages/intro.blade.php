...
{{--            </div>--}}
            <div class="carousel-item slide-1">
                <video width="400" height="440"  controls>
                    <source src="{{asset('images/gallery/intro-features.png')}}" type="video/mp4">
                    <source src="https://cofepedia.com/demo.mp4" type="video/ogg">
                    Your browser does not support the video tag.
                </video>

              <h5 class="intro-step-title mt-7 center">Example How add</h5>
